...
class ReportCommentRepository(BaseRepository[ReportComment, ReportCommentCreate, ReportCommentUpdate]):
...
report_comment_repository = ReportCommentRepository(ReportComment) 